...
class TipoNotificao():
    ...
    def PreencheDados(self):
        ...
        #j_id_78_2_1_5_5b_1:eFileTipoCombo_32
    ...
    def PreencheDados(self):
        ...
        try:
            for pos, obj in enumerate(self.urls):
                ...
                #elf.navegador.find_element('id', 'j_id_p:j_id_r_2_e_2_1_input').send_keys(r"C:\Users\JoséGabrielNevesBuen\Downloads\{}".format(self.nomes[pos]))
                time.sleep(5)
        except:
            pass
